...
module.exports = {
    ...
    [TRADE_TOOLS]: [
        ...
        },
        {
            weight: 1,
            entry: 'Bellows',
            base_material: 'Wood with 1 - 8 Leather 9 - 10 Cloth"',
            [SIZE]: 'M',
            [ADJECTIVES]: 1,
            [COLORS]: 2,
            [ENGRAVINGS]: 1,
        ...
        },
        {
            weight: 1,
            entry: 'Funnel',
            base_material: '1 - 8 Waxed Leather 9 - 10 Waxed Cloth',
            [SIZE]: 'S',
            [ADJECTIVES]: 1,
            [COLORS]: 1,
            [STITCHINGS]: 1,
    ...
    [HEADGEAR]: [
        ...
        },
        {
            weight: 2,
            entry: 'Hat',
            base_material: '1 - 3 Felt 4 - 7 Straw 8 Cloth 9 Leather 10 Fur',
            [SIZE]: 'S',
            [ADJECTIVES]: 1,
            [COLORS]: 1,
            [STITCHINGS]: 1,
    ...
    other_table: [
        ...
        { entry: 'Bone, Monster', value: '3 sc' },
        {
            entry: 'Bone, Sentient',
            value: '5 sc',
            subtable: 'See Race of Origin subtable'
        },
        { entry: 'Chalk', value: '0.1 sc' },
        { entry: 'Chewing Tobacco', value: '0.873 sc' },
        { entry: 'Cotton', value: '0.148 sc' },
        { entry: 'Crystal', value: '3.75 sc' },
        {
            entry: 'Down',
            value: '1.75 sc',
        ...
        { entry: 'Felt', value: '2.5 sc' },
        { entry: 'Gauze', value: '1.1725 sc' },
        { entry: 'Glass', value: '5 sc' },
        {
            entry: 'Goose Feather',
            value: '1.18 sc',
            subtable: 'See Animal > Air subtable'
        ...
        { entry: 'Hemp Oil', value: '0.17 sc' },
        {
            entry: 'Horn',
            value: '2.25 sc',
            subtable: 'See Animal > Land subtable'
        },
        { entry: 'Ivory', value: '5 sc' },
        { entry: 'Linseed Oil', value: '0.581 sc' },
        { entry: 'Porcelain', value: '3.75 sc' },
        { entry: 'Porcupine Spine', value: '0.737 sc' },
        { entry: 'Smoking Tobacco', value: '1.5 sc' },
        { entry: 'Straw', value: '0.0005 sc' },
        { entry: 'Tallow', value: '0.091 sc' },
        { entry: 'Thread', value: '0.009 sc' },
        { entry: 'Twine', value: '0.02 sc' },
        { entry: 'Whale Oil', value: '0.0097 sc' },
        { entry: 'Wicker (see Wood)', value: '0.08 sc', subtable: 'See Wood subtable' },
        { entry: 'Wool', value: '0.48 sc' }
    ]
}